from my_design.jzp.delayline.column3 import customWavegudie
from si_fab import all as pdk
from ipkiss3 import all as i3

wg3000 = pdk.SiWireWaveguideTemplate()
wg3000.Layout(core_width=2,
              cladding_width=2 + 7)
...
class customTaper(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_ports(self, ports):
            ...
            ports += i3.OpticalPort(name='out', position=(taperLength, 0.0), angle=0.0, trace_template=wg3000)
            return ports
...
class customWavegudie(i3.PCell):
    ...
    Width2 = i3.PositiveNumberProperty(default=0.33, doc="wide width.")
    taperLength = i3.PositiveNumberProperty(default=100., doc="taperLength.")
...
if __name__ == '__main__':
    testtaper = customWavegudie()
    testtaper.Layout().write_gdsii('test.gds')